...
namespace Laba3
{
    public partial class ChartTwo : Form
    {
        ...
        private void ChartTwo_Load(object sender, EventArgs e)
        {
            ...
            System.Windows.Forms.DataVisualization.Charting.Series series1 = new System.Windows.Forms.DataVisualization.Charting.Series("X2");
            series1.ChartType = SeriesChartType.Line;
            series1.BorderWidth = 5;
            series1.Points.DataBindY(matrix.X2);
        ...
        {
            var regressionCoefficients = Fit.Line(matrix.Y, matrix.X2);

            double slope = regressionCoefficients.Item2;
            double intercept = regressionCoefficients.Item1;

            string equation1 = $"X2 = {slope} * Y + {intercept}";
            ...
            for (int i = 0; i < matrix.Y.Length; i++)
            {
                series2.Points.AddXY(matrix.Y[i], matrix.X2[i]);
            }
